                                            ...
                                            <td class="tw-card-body"
                                                ...
                                                <p class=""
                                                   style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                    <span style="font-weight: 400;">Please click the below button to change your password for <strong>Flowcontrol</strong>.The link will be valid for next ${expirationTime} minutes.</span><br/><br/><span
                                                ...
                                                <p class="tw-signoff"
                                                   style="margin: 45px 0 5px; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                    Our best, <br/> The Flowcontrol Engagement App team <small>Rik Peeters</small></p>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
