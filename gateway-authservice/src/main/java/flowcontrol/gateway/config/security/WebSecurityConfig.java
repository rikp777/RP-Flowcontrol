...
import flowcontrol.gateway.security.JwtAuthenticationEntryPoint;
import flowcontrol.gateway.security.JwtAuthenticationFilter;
...
@EnableJpaRepositories(basePackages = "flowcontrol.gateway.repository")
