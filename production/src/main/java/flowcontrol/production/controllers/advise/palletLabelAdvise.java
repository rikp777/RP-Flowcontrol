package flowcontrol.production.controllers.advise;


import flowcontrol.production.exception.*;
import flowcontrol.production.model.response.ApiResponse;
...
@Slf4j
@AllArgsConstructor
public class palletLabelAdvise {
    ...
    @ResponseStatus(HttpStatus.CONFLICT)
    @ResponseBody
    public ApiResponse handleTicketException(TicketException exception, WebRequest request){
        return new ApiResponse(
                false,
                exception.getMessage(),
                exception.getClass().getName(),
    ...
    @ResponseStatus(HttpStatus.CONFLICT)
    @ResponseBody
    public ApiResponse handleInterruptionException(InterruptionException exception, WebRequest request){
        return new ApiResponse(
                false,
                exception.getMessage(),
                exception.getClass().getName(),
